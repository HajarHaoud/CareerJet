            ...
            <?php
                ...
                if (isset($_POST['login'])) {
                    ...
                    else 
                    {
                        ...
                        echo "<a href='login_recruteur.php'><button class='btn'>Go Back</button></a>";
                    }
                        ...
                        echo "<a href='login__recruteur.php'><button class='btn'>Go Back</button></a>";
                    }
                    ...
                    <label for="submit"><a href="dashboard.html"></a></label>
